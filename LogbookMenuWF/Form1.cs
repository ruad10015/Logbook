...
namespace LogbookMenuWF
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            std1.lbl_StudInfo.Text = "Dunyamaliyev Ruad Vusal";
            std1.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std1.pb_ImageBig.Image = Resources.Ruad;
            std1.pb_std.Image = Resources.Ruad;

            std2.lbl_StdNum.Text = "2";
            std2.lbl_StudInfo.Text = "Eliyev Eli Sohret";
            std2.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std2.pb_ImageBig.Image = Resources.Eli;
            std2.pb_std.Image = Resources.Eli;

            std3.lbl_StdNum.Text = "3";
            std3.lbl_StudInfo.Text = "Memmedov Enver Azer";
            std3.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std3.pb_ImageBig.Image = Resources.Enver;
            std3.pb_std.Image = Resources.Enver;

            std4.lbl_StdNum.Text = "4";
            std4.lbl_StudInfo.Text = "Aslanov Vuqar Ilqar";
            std4.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std4.pb_ImageBig.Image = Resources.Vuqar;
            std4.pb_std.Image = Resources.Vuqar;

            std5.lbl_StdNum.Text = "5";
            std5.lbl_StudInfo.Text = "Akberli Elnur Zahid";
            std5.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std5.pb_ImageBig.Image = Resources.Elnur;
            std5.pb_std.Image = Resources.Elnur;

            std6.lbl_StdNum.Text = "6";
            std6.lbl_StudInfo.Text = "Poladov Ulvi Eyyub";
            std6.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std6.pb_ImageBig.Image = Resources.Ulvi;
            std6.pb_std.Image = Resources.Ulvi;

            std7.lbl_StdNum.Text = "7";
            std7.lbl_StudInfo.Text = "Quliyev Nihat Elxan";
            std7.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std7.pb_ImageBig.Image = Resources.Nihat;
            std7.pb_std.Image = Resources.Nihat;

            std8.lbl_StdNum.Text = "8";
            std8.lbl_StudInfo.Text = "Veliyev Hebib Nebi";
            std8.lbl_LastAccessDate.Text = new DateTime(2023, 10, 18).ToShortDateString();
            std8.pb_ImageBig.Image = Resources.Hebib;
            std8.pb_std.Image = Resources.Hebib;
